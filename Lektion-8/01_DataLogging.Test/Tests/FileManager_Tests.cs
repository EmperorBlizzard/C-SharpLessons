...
namespace _01_DataLogging.Test.Tests;
...
public class FileManager_Tests
{
    ...
    [Fact] //Integrationts Test (går mot ett annat system, såsom filsystemet på datorn)
    public void SaveToFile_Shoud_ReturnTrue_WhenContentIsWrittenToRealFile()
    {
        //Arrange
    ...
    [Fact] //Unit test (testar bara själva funktionaliteteten, ingen koppling till något annat systme)
    ...
    [Fact]
    public void ReadFromFile_Shoud_ReturnNull_WhenFileDoesNotExist()
    {
        //Arrange
        IFileManager fileManager = new FileManager();
